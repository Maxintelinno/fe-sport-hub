...
import { addBankAccount } from '../../services/profileService';
    ...
    const handleSave = async () => {
        ...
        try {
            await addBankAccount({
                ...
                bank_name: selectedBank!.display,
        ...
        >
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.header}>
                    <Text style={styles.headerTitle}>เพิ่มบัญชีรับเงิน</Text>
                    <Text style={styles.headerSubtitle}>กรุณาระบุข้อมูลบัญชีธนาคารให้ถูกต้องเพื่อความรวดเร็วในการรับเงิน</Text>
                </View>
                ...
                >
                    {loading ? (
                        ...
                        <Text style={styles.saveButtonText}>บันทึกบัญชี</Text>
                    )}
                </TouchableOpacity>
            </ScrollView>
        </KeyboardAvoidingView>
